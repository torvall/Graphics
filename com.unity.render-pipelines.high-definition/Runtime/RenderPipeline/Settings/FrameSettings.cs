...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public enum FrameSettingsField
    {
        ...
        [FrameSettingsField(0, displayedName: "Lit Emissive as Forward", positiveDependencies: new[] { LitShaderMode }, customOrderInGroup: 3, tooltip: "When enabled, The emissive part of the materials is rendered as a forward pass for the deferred pipeline.")]
        LitEmissiveAsForward = 57,
